/*
 * BeneG Toolkit - Anchor Bottom Center
 *
 * Moves the anchor point to the bottom center of each selected layer, adjusting position so the layer stays put.
 *
