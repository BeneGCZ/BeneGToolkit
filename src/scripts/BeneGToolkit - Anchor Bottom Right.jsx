/*
 * BeneG Toolkit - Anchor Bottom Right
 *
 * Moves the anchor point to the bottom right of each selected layer, adjusting position so the layer stays put.
 *
