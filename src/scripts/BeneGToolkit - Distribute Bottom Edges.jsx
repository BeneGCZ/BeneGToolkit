/*
 * BeneG Toolkit - Distribute Bottom Edges
 *
 * Spaces the selected layers evenly by their bottom edges. Needs at least three layers.
 *
...
(function () {
    bgtRun("distributeLayers('vBottom')");
})();
