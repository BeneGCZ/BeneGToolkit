/*
 * BeneG Toolkit - Distribute Centers V
 *
 * Spaces the selected layers evenly by their vertical centres. Needs at least three layers.
 *
...
(function () {
    bgtRun("distributeLayers('vCenter')");
})();
