/*
 * BeneG Toolkit - Anchor Bottom Left
 *
 * Moves the anchor point to the bottom left of each selected layer, adjusting position so the layer stays put.
 *
