/*
 * BeneG Toolkit - Anchor Middle Right
 *
 * Moves the anchor point to the middle right of each selected layer, adjusting position so the layer stays put.
 *
