/*
 * BeneG Toolkit - Anchor Top Right
 *
 * Moves the anchor point to the top right of each selected layer, adjusting position so the layer stays put.
 *
